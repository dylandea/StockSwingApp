...
//
//import fr.fms.bdd.Authenticate;
...
//		System.out.println(Product.centerString(COLUMN_ID) + Product.centerString(COLUMN_DESCRIPTION) + Product.centerString(COLUMN_BRAND) + Product.centerString(COLUMN_PRICE));
...
//		int id = scanInt();
//		Product article = business.readOneArticle(id);
//		if(article != null) {
...
//			String titles = Product.centerString(COLUMN_ID) + Product.centerString(COLUMN_DESCRIPTION) + 
//					Product.centerString(COLUMN_BRAND) + Product.centerString(COLUMN_PRICE) + Product.centerString("QUANTITE");
//			System.out.println(titles);
//			business.getCart().forEach(a -> System.out.println(a.toString() + Product.centerString(String.valueOf(a.getQuantity()))));
//			if(flag) {
